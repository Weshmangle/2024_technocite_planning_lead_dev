            ...
            <div className='container'>
                ...
                <div className="btn-group container p-5 my-5 text-center">
                    <div className="col-sm-4">
                        <button type="button" className="btn btn-secondary p-4" onClick={_ => clickButtonPreviousWeek()}> <i className="fa-solid fa-caret-left">  </i> </button>
                    </div>
                    <div className="col-sm-4"> <h1> Semaine {idPage} </h1> </div>
                    <div className="col-sm-4">
                        <button type="button" className="btn btn-secondary p-4" onClick={_ => clickButtonNextWeek()}> <i className="fa-solid fa-caret-right"></i> </button>
                    </div>
                </div> 
            </div>
        </div>);
